 ...
 * 4,335 rows per keystroke rather than over one page of API results.
 *
 ...
 * whole 4,335-row Search index (ADR-0047 §4). Re-splitting every description on
 ...
 *
 * Reaches 127 of the 4,335 shipped rows under 78 parents, the largest two being
