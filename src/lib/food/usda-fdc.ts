...
// ---------------------------------------------------------------------------
// Reference-food matching and ranking (ADR-0042 §5)
// ---------------------------------------------------------------------------
 ...
 *
 * An empty query scores every name as a head-phrase match, since every token
 * matches vacuously. Callers that treat an empty query as "no search" guard it
 * before compiling.
 */
