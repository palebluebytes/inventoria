 ...
 * answer, and "all agree" is a fact about the 4,358 rows that survived ADR-0048
 ...
 * `salt` matches 427 of the 4,358 rows, `whole` 218, `beans` 115 — and
 ...
 * asserted against a handful of stated retrieval counts instead of against 4,358
 ...
 * 4,358 rows, and the one impure, expensive step stays in
 ...
 * on the corpus per question. Rebuilding the corpus per call would re-read 4,358
