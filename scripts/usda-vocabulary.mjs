 ...
 * answer, and "all agree" is a fact about the 4,429 rows that survived ADR-0048
 ...
 * `salt` matches 424 of the 4,429 rows, `whole` 217, `beans` 116 — and
 ...
 * asserted against a handful of stated retrieval counts instead of against 4,429
