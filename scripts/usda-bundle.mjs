 ...
 * ADR-0061's variant drops out of `src/lib/food/usda-variant-drops.ts`;
 ...
 * `usda-app-module.mjs` names in its seven rosters, and nothing this script is
