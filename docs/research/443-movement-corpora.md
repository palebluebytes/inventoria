...
| **Findability of published names** | USDA's raw names needed [ADR-0056](../adr/0056-a-name-loses-the-parts-that-do-not-name-the-food.md) and a whole shipped-name arc. Question 6 asks whether these have the same problem. They have a _different_ one — see §4.                                                                                                |
