...
> **Ticket:** [#49](https://github.com/inkpot-monkey/inventoria/issues/49) — parent map [#47](https://github.com/inkpot-monkey/inventoria/issues/47) (label-photo food-capture).
