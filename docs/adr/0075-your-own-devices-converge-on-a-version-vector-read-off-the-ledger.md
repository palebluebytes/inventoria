...
**Amended by:** [ADR-0105](0105-a-pairing-is-scoped-to-the-facet-its-act-ran-in.md) (§6's version vector is re-keyed by originating device **and** Tracked Domain; it stays a read of `datoms`, and its argument against a scalar watermark survives widened to a second axis)
