...
**Amended by:** [ADR-0101](0101-the-ways-into-a-day-are-one-bar-anchored-where-the-hand-is.md) §4 (§3's "owns the foot of the screen" becomes "owns one slot": the foot of the band on a phone, the head of the day's column above 768); [ADR-0108](0108-a-correction-is-another-datom-on-the-event-never-another-event.md) (§8's move stops being the exception, and the 2026-09-02 scaled-row amendment keeps one of its two reasons)  
...
## Amendment (ADR-0108 / #463): a move was the rule all along, and the release keeps one reason of two
...
retracts". After ADR-0108 every correction does what a move does, so a move is not a
...
one minted" — stops being true. After ADR-0108 nothing is retracted, no successor
