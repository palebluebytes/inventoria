...
**Status:** Accepted  
**Date:** 2026-09-15  
**Amended by:** [ADR-0108](0108-a-correction-is-another-datom-on-the-event-never-another-event.md) (the exclusion of corrections keeps its rule and changes its reason)  
...
## Amendment (ADR-0108 / #463): a correction still does not reveal, for a different reason
...
fresh id for a row you were already looking at". ADR-0108 removes the premise. A
...
in `dayItems`, and after ADR-0108 the id is already there. A correction path that
