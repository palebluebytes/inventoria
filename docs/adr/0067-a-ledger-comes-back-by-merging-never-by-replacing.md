...
**Amended by:** [ADR-0096](0096-devices-converge-without-both-being-awake-through-a-store-of-sealed-deltas.md) (§1's two-deliberate-steps argument gains a case it does not know about: an import does not apply held carried deletions, so a pre-wipe backup restores as it always did)  
