...
**Superseded by:** [ADR-0092](0092-a-local-log-records-completely-at-a-level-and-the-export-is-the-protection.md), which reverses §1's _channels rather than levels_ and §2's _no channel without a named reader and a question_, and carries this record's storage rule, budget, counters and no-transport property forward  
