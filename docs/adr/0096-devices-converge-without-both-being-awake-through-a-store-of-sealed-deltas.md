...
**Amended by:** [ADR-0105](0105-a-pairing-is-scoped-to-the-facet-its-act-ran-in.md) (§7's _a Rations-only user never converges_ is repaired rather than restated; §3's Deposit gains a scope, §8's closing exchange gains one statement, §11's K counter becomes per-pairing and blind to which Facet woke, and §12's carried deletion gains the subset rule)
...
ADR-0105 §9 lands — a root tab beside an installed Rations. A `localStorage` flag is not atomic,
