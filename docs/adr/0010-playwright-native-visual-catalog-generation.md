...
**Pointer (2026-09-07):** what a picture taken this way is allowed to _claim_ — how closely two of them must match, that one test asserts one capture, and what a commit that replaces one owes — is [ADR-0099](0099-a-capture-asserts-one-screen-at-a-derived-tolerance-and-moving-one-owes-an-account.md). This record chose the tool and said nothing about any of that; nothing above is amended.
