...
**Amended by:** [ADR-0103](0103-a-pairing-is-scoped-to-the-facet-its-act-ran-in.md) (§7's refusal to let a sender learn about the recipient's device is stated not to govern own-device pairing, which it was never written about)
