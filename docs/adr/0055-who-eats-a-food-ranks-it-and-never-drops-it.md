...
**Amended by:** [ADR-0103](0103-what-was-done-to-a-food-is-not-another-food.md) §7, which gives §1 a third ground and the narrowest of the three — a row differing from a shipping row only on collapsing axes — and declines the general drop licence it was commissioned to take  
**Amended by:** [ADR-0104](0104-the-corpus-is-ingredients-as-bought-and-not-yet-cooked.md) §1, which gives §1 a fourth ground and the WIDEST of the four — a record USDA cooked before it measured it is not a Reference food — and pays for it with fourteen foods that have no survivor, listed in its §8  
