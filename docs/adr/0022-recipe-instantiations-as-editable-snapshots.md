...
**Status:** Accepted  
**Amended by:** ADR-0030 (#28), see the amendment below; [ADR-0105](0105-a-recipe-occasion-is-sized-by-the-weight-you-put-on-the-scale.md) (the servings amendment's count is no longer the only way to size an occasion, and the logged quantity stops being a literal)  
