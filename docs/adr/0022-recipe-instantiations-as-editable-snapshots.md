...
**Status:** Accepted  
**Amended by:** ADR-0030 (#28), see the amendment below; [ADR-0108](0108-a-correction-is-another-datom-on-the-event-never-another-event.md) (§2's "editing is by supersession" bullet and its ADR-0008 citation; the snapshot principle itself stands)  
...
## Amendment (ADR-0108 / #463): editing is an append onto the event, and the inherited citation is struck
...
doubled total. Measured in #463 and quoted in ADR-0108.
...
chain of them. ADR-0108 §3 adds the one constraint that follows: every datom of a
