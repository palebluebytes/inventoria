...
**Amended by:** [ADR-0096](0096-devices-converge-without-both-being-awake-through-a-store-of-sealed-deltas.md) (§1's sentence survives word for word and its subject widens: a Tracked Domain need not have a screen and need not belong to a Facet, which is what gives a jar-wide minted entity a home)  
