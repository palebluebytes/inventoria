...
of this record's seven sections stand exactly as written — §1's consent model, §2's *one
entry per session*, §5, and §7's bar and its numbers. This amendment states the rest.
...
and #142's tier measurable as *proportions* rather than as raw counts.
...
*default*, and never the absence of a control.
...
denominator was expressed in code as *settled and not `rescued_by_vocabulary`*, which was
