...
**Status:** Accepted  
**Date:** 2026-08-06  
**Amended by:** ADR-0043 §2 (the badge moves onto the portions row as one of several tags); the Amendment below, which supersedes §1, §3, §5, §6 of the original decision; and [ADR-0104](0104-a-volume-food-is-weighed-by-the-class-you-say-it-is.md) §11 (§3's client-side inference ban gains a second carve-out, for a density figure resolved from a class the user asserted)  
